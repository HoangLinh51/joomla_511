...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
    ...
    itemHtml += '<LI id="' + this.comboTreeId + 'Li' + sourceItem.id + '" rel="'+sourceItem.type+'" class="ComboTreeItem' + (isThereSubs?'Parent':'Chlid') + ' '+sourceItem.type+'"> ';

    if (isThereSubs)
      itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse || collapse ? '<span class="mdi mdi-chevron-right-circle-outline">.</span>' : '<span class="mdi mdi-chevron-down-circle-outline">.</span>') + '</span>'; 
  ...
  ComboTree.prototype.toggleSelectionTree = function (item, direction) {
    ...
    $("ul:not(:has(li))").addClass('hidden_bullet');
    $(".hidden_bullet").closest().css('background: red');
    $("ul:not(:has(li))").parent().addClass('hidden_bullet_1');
    $('.hidden_bullet_1 .comboTreeParentPlus .mdi-chevron-right-circle-outline').addClass("hidden_bullet_1")
