...
(l => {
  l.addEventListener("DOMContentLoaded", () => {
    [].slice.call(l.querySelectorAll('input[type="password"]')).forEach(e => {
      const o = e.parentNode.querySelector(".input-password-toggle");
      if (o) {
        o.addEventListener("click", () => {
          const t = o.firstElementChild,
            c = o.lastElementChild;
          if (e.type === "password") {
            t.classList.remove("icon-eye");
            t.classList.add("icon-eye-slash");
            e.type = "text";
            e.focus();
            c.innerHTML = '<i class="far fa-eye-slash"></i>';  // 👈 thay text bằng icon
          } else {
            t.classList.add("icon-eye");
            t.classList.remove("icon-eye-slash");
            e.type = "password";
            e.focus();
            c.innerHTML = '<i class="far fa-eye"></i>';  // 👈 thay text bằng icon
          }
        });
      }

      const s = e.parentNode.querySelector(".input-password-modify");
      if (s) {
        s.addEventListener("click", () => {
          if (!s.classList.contains("locked") === true) {
            s.classList.add("locked");
            e.value = "";
            e.setAttribute("disabled", "");
            s.innerText = Joomla.Text._("JMODIFY");
          } else {
            s.classList.remove("locked");
            e.removeAttribute("disabled");
            e.focus();
            s.innerText = Joomla.Text._("JCANCEL");
          }
        });
      }
    });
