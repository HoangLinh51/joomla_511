...
<div class="wrapper">
	<?php //echo Uri::root(true). '/templates/' .$this->template. '/dist/css/adminlte.min.css';exit; ?>
	<!-- Preloader -->
	<!-- <div class="preloader flex-column justify-content-center align-items-center">
		<img class="animation__wobble" src="templates/adminlte/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
	</div> -->
	<div class="preloader flex-column justify-content-center align-items-center" style="height: 0px;">
	 ...
	 <!-- <header class="main-header">
		<nav class="navbar navbar-static-top">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a style="" class="sidebar-toggle nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
				</li>
			</ul>
