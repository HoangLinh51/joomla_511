...
namespace Joomla\Component\Decentralization\Administrator\Service\HTML;
        ...
        if ($self) {
            $states = [
                1 => [
                    'task'           => 'unblock',
                    'text'           => '',
                    'active_title'   => 'COM_DECENTRALIZATION_TOOLBAR_BLOCK',
                    'inactive_title' => '',
                    'tip'            => true,
            ...
            $states = [
                1 => [
                    'task'           => 'unblock',
                    'text'           => '',
                    'active_title'   => 'COM_DECENTRALIZATION_TOOLBAR_UNBLOCK',
                    'inactive_title' => '',
                    'tip'            => true,
                    'active_class'   => 'unpublish',
                    'inactive_class' => 'unpublish',
