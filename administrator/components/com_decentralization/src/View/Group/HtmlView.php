...
namespace Joomla\Component\Decentralization\Administrator\View\Group;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title("Nhóm người dùng: " .Text::_($isNew ? 'COM_DECENTRALIZATION_VIEW_NEW_GROUP_TITLE' : 'COM_DECENTRALIZATION_VIEW_EDIT_GROUP_TITLE'), 'grid');
