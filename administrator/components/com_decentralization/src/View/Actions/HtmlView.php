 ...
 */
namespace Joomla\Component\Decentralization\Administrator\View\Actions;
...
{    
    ...
    public function addToolbar() {
        ToolbarHelper::title(Text::_('COM_DECENTRALIZATION_ACTIONS'), 'grid');
        $toolbar = Toolbar::getInstance();
        $canDo = $this->canDo;
        $user  = $this->getCurrentUser();
        if ($canDo->get('core.create')) {
            $toolbar->addNew('action.add');
        }
        if ($canDo->get('core.delete')) {
            $toolbar->delete('actions.delete', 'JTOOLBAR_DELETE')
