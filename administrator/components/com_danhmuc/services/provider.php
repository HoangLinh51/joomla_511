...
use Joomla\Component\Danhmuc\Administrator\Extension\DanhmucComponent;
    ...
    public function register(Container $container): void 
    {
        ...
        $container->set(
            ...
            function (Container $container) {
                $component = new DanhmucComponent($container->get(ComponentDispatcherFactoryInterface::class));
