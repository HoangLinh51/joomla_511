...
?>
<form action="<?php echo Route::_('index.php?option=com_decentralization&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                    ...
                    <table class="table" id="userList">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <?php echo Text::_('COM_DECENTRALIZATION_HEADING_MOUDULES_NAME', 'a.title'); ?>
                                </th>
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            $canChange  = $user->authorise('core.edit.state', 'com_decentralization' . '.group.' . $item->id);
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <th scope="row">
                                    ...
                                    <?php if ($canEdit) : ?>
                                        <a href="<?php echo Route::_('index.php?option=com_decentralization&task=group.edit&id=' . $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->title); ?>">
