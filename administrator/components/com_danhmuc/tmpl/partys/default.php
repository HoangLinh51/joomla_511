...
?>
<form action="<?php echo Route::_('index.php?option=com_danhmuc&view=partys'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table" id="userList">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_DANHMUC_CHUCVUDANG_NAME', 'a.name', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_DANHMUC_CHUCVUDANG_LEVEL', 'a.level', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" class="d-none d-md-table-cell">
                                <?php echo Text::_('COM_DANHMUC_CHUCVUDANG_STATUS'); ?>
                            </th>
                            <th scope="col" class="w-5 text-center d-md-table-cell">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_DANHMUC_CHUCVUDANG_CODE', 'a.code', $listDirn, $listOrder); ?>
                            </th>
                        </tr>
                    </thead>
                    <tbody<?php if ($saveOrder) :
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            $canChange  = $user->authorise('core.edit.state', 'com_danhmuc' . '.partys.' . $item->code);
                        ...
                        ?>
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <td class="text-center d-md-table-cell">
                                    ...
                                    <?php echo HTMLHelper::_('jgrid.published', $item->status, $i, 'partys.', $canChange); ?>
