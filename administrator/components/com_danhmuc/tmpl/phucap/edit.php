...
?>
<form action="index.php?option=com_danhmuc&view=nangluong&layout=edit&code=<?php echo (int) $this->item->code ?>" method="post" name="adminForm" id="adminForm" class="form-horizontal form-validate">
        ...
        <div class="span12 form-horizontal">
            <fieldset>
                ...
                <div id="div_report_group">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <?php echo $this->form->renderField('raise_salary') ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
                            <?php echo $this->form->renderField('receive_money') ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
