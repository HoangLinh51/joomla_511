...
/** @var \Joomla\Component\Danhmuc\Administrator\View\Phucap\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_danhmuc&view=phucap'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table" id="userList">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_DANHMUC_CACLOAIPHUCAP_NAME', 'a.name', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" class="d-none d-md-table-cell">
                                <?php echo Text::_('COM_DANHMUC_CACLOAIPHUCAP_NANGLUONG'); ?>
                            </th>
                            <th scope="col" class="d-none d-md-table-cell">
                                <?php echo Text::_('COM_DANHMUC_CACLOAIPHUCAP_NHAPTIEN'); ?>
                            </th>
                            <th scope="col" class="d-none d-md-table-cell">
                                <?php echo Text::_('COM_DANHMUC_CACLOAIPHUCAP_PERCENT'); ?>
                            </th>
                            <th scope="col" class="d-none d-md-table-cell">
                                <?php echo Text::_('COM_DANHMUC_CACLOAIPHUCAP_STATUS'); ?>
                            </th>
                            <th scope="col" class="w-5 text-center d-md-table-cell">
                                <?php echo HTMLHelper::_('searchtools.sort', 'COM_DANHMUC_CACLOAIPHUCAP_CODE', 'a.code', $listDirn, $listOrder); ?>
                            </th>
                        </tr>
                    </thead>
