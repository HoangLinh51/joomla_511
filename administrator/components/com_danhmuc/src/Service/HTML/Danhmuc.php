...
namespace Joomla\Component\Danhmuc\Administrator\Service\HTML;
...
use Joomla\Component\Danhmuc\Administrator\Helper\DanhmucHelper;
...
class Danhmuc
{
        ...
        if ($self) {
            $states = [
                1 => [
                    'task'           => 'unblock',
                    'text'           => '',
                    'active_title'   => 'COM_Danhmuc_TOOLBAR_BLOCK',
                    'inactive_title' => '',
                    'tip'            => true,
            ...
            $states = [
                1 => [
                    'task'           => 'unblock',
                    'text'           => '',
                    'active_title'   => 'COM_Danhmuc_TOOLBAR_UNBLOCK',
                    'inactive_title' => '',
                    'tip'            => true,
                    'active_class'   => 'unpublish',
                    'inactive_class' => 'unpublish',
    ...
    public function donvi($donvi_id){
        ...
        DanhmucHelper::makeParentChildRelationsForTree($inArray, $tree_donvi);
        unset($inArray);
