 ...
 * @since  3.7.0
 */
class PartysModel extends ListModel
{
     ...
     * @throws  \Exception
     */
    public function getTable($type = 'Partys', $prefix = 'Joomla\\Component\\Danhmuc\\Administrator\\Table\\', $config = [])
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_danhmuc.partys', 'partys', ['control' => 'jform', 'load_data' => $loadData]);
