 ...
 * @since  1.6
 */
class ChucvuController extends FormController
{
    /**
     * @var    string  The prefix to use with controller messages.
     * @since  1.6
     */
    protected $text_prefix = 'COM_DANHMUC_GROUP';
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        /** @var \Joomla\Component\Danhmuc\Administrator\Model\GroupModel $model */
        ...
        if ($task == 'save2new'){
			$link = 'index.php?option=com_danhmuc&view='.$view.'&layout=edit';
			$this->setRedirect($link, $msg);
		}else if($task == 'save') {
			$link = 'index.php?option=com_danhmuc&view=chucvus';
			$this->setRedirect($link, $msg);
		}else if($task == 'apply') {
            $link = 'index.php?option=com_danhmuc&view='.$view.'&layout=edit&id='.$id;
			$this->setRedirect($link, $msg);
        }
