 ...
 * @since  1.6
 */
class ChucvusController extends AdminController
{
    /**
     * Constructor.
     *
     ...
     * @since   1.6
     */
    public function getModel($name = 'Chucvu', $prefix = 'Administrator', $config = ['ignore_request' => true])
    {
    ...
    public function delete()
    {
        ...
        $this->setRedirect('index.php?option=com_danhmuc&view=chucvus');
    }
}