...
?>
<form action="<?php echo Route::_('index.php?option=com_core&view=config&client_id=' . $clientId . '&layout=' . $layout . $tmpl); ?>" method="post" name="adminForm" id="adminForm" aria-label="" class="form-validate">
...
<input type="hidden" name="jform[config_field_id]" value="<?php echo $this->item->id?>">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input class="form-control" type="text" name="path" readonly="readonly" id="path" value="<?php echo $this->item->path?>">
    </div>
  </div>  
