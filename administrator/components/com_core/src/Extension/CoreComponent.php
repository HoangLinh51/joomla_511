...
namespace Joomla\Component\Core\Administrator\Extension;
 ...
 * @since  4.0.0
 */
class CoreComponent extends MVCComponent implements BootableExtensionInterface, RouterServiceInterface, FieldsFormServiceInterface
{
