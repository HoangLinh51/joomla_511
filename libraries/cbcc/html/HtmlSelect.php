...
abstract class HtmlSelect
{
	 ...
	 * @see     JFormFieldRadio
	 */
	public static function booleanlist($name, $attribs = array(), $selected = null, $yes = 'Có', $no = 'Không', $id = false)
	{
		$arr = array(Core::html('select.option', '0', JText::_($no)), Core::html('select.option', '1', JText::_($yes)));

		return Core::html('select.radiolist', $arr, $name, $attribs, 'value', 'text', $selected, $id);
	}
	...
	public static function integerlist($start, $end, $inc, $name, $attribs = null, $selected = null, $format = '')
	{
		...
		return Core::html('select.genericlist', $data, $name, $options);
	}
