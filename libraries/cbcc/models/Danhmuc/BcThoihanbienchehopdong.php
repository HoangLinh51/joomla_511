<?php
class Danhmuc_Model_BcThoihanbienchehopdong extends JModelLegacy
{
	/**
	...
	public function create($formData){
		$table = Core::table('Danhmuc/BcThoihanbienchehopdong');
		$src['name'] = $formData['name'];
		$src['status'] = $formData['status'];
		$src['month'] = $formData['month'];
		$src['deadline'] = $formData['deadline'];
