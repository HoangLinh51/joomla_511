<?php
class Danhmuc_Model_DependStatus extends JModelLegacy
{
	/**
	...
	public function create($formData){
		$table = Core::table('Danhmuc/DependStatus');
		$src['name']          = $formData['name'];
		$src['status_code']   = $formData['status_code'];
	...
	public function getData_Query($query=null)
	{
	    // Load the data
	    $db = JFactory::getDbo();
	    $db->setQuery($query);
