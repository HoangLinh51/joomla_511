	...
	<div class="card">
		<div class="card-header">
			...
			<div>
				...
				<?php endif; ?>
				<a href="<?= Route::_('index.php?option=com_baocaoloi&view=baocaoloi&task=ds_baocaoloi') ?>" class="btn btn-secondary">Quay lại</a>
			</div>
		</div>
		<div class="card-body">
			<!-- Thông tin lỗi -->
...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		$('body').on('click', '.btn-submit', function() {
			...
			const url = "<?= Route::_('index.php?option=com_baocaoloi&task=baocaoloi.confirm_reason') ?>";
