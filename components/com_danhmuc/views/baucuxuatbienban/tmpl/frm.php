...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form class="form-horizontal" method="POST" name="frm_baucuxuatbienban" id="frm_baucuxuatbienban">
		...
		<div class="modal-footer">
			...
			<span class="btn btn-sm btn-primary pull-right" id="btn_submit_baucuxuatbienban">
				<i class="ace-icon fa fa-times"></i>
				Lưu
			</span>
		</div>
...
jQuery(document).ready(function($){
	...
	$('#btn_submit_baucuxuatbienban').click(function(){
		$('.gritter-item-wrapper').remove();
		var flag = $('#frm_baucuxuatbienban').valid();
		if(flag == true){
			$.blockUI();
			formData = $('#frm_baucuxuatbienban').serialize();
			$.ajax({
				type: 'post',
				data: formData,
				url: 'index.php?option=com_danhmuc&controller=baucuxuatbienban&task=save&format=raw&',
