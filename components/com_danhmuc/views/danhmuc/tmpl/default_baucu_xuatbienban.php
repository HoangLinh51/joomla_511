...
$array = array(
    ...
    $i++ => array('tbl' => 'baucu_null', 'href' => 'tab_' . $view . '_' . 'khuvucbophieu', 'url' => 'index.php?option=com_danhmuc&controller=baucuxuatbienban&task=default_khuvucbophieu&format=raw', 'ten' => 'Thống kê khu vực bỏ phiếu'),
    // $i++ => array('tbl' => 'baucu_null', 'href' => 'tab_' . $view . '_' . 'danhsachcutri', 'url' => 'index.php?option=com_danhmuc&controller=baucuxuatbienban&task=default_danhsachcutri&format=raw', 'ten' => 'Thống kê danh sách cử tri'),
...
<div id="tabs" class="tabbable" style="width: 100%;">
    <ul class="nav nav-tabs" id="myTab">
        <?php for ($i = 0; $i < count($array); $i++) { ?>
            <?php if (Core::_checkPerActionArr($user_id, 'com_danhmuc', 'danhmuc', array('task' => $array[$i]['href'], 'location' => 'site', 'non_action' => 'false')) || $debug == 1) { ?>
                <li>
