...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form class="form-horizontal" method="POST" name="frm_vtvlmucdonangluc" id="frm_vtvlmucdonangluc">
				<div class="row-fluid">
		...
		<div class="modal-footer">
			...
			<span class="btn btn-sm btn-primary pull-right" id="btn_submit_vtvlmucdonangluc">
				<i class="ace-icon fa fa-times"></i>
				Lưu
			</span>
		</div>
...
jQuery(document).ready(function($){
	...
	$('#btn_submit_vtvlmucdonangluc').click(function(){
		$('.gritter-item-wrapper').remove();
		var flag = $('#frm_vtvlmucdonangluc').valid();
		if(flag == true){
			$.blockUI();
			formData = $('#frm_vtvlmucdonangluc').serialize();
			$.ajax({
				type: 'post',
				data: formData,
				url: 'index.php?option=com_danhmuc&controller=vtvlmucdonangluc&task=save&format=raw&',
