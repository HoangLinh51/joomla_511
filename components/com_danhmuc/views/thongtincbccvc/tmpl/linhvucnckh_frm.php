...
<div class="modal-header">
    ...
    <h4 class="blue bigger" id="modal-title"><?php echo ($data['id'] > 0) ? 'Hiệu chỉnh' : 'Thêm mới' ?> Lĩnh vực nghiên cứu khoa học</h4>
</div>
<div class="modal-body">
    <form class="form-horizontal" id="form_linhvucnckh" enctype="multipart/form-data">
...
<div class="modal-footer">
    <span class="btn btn-small btn-success" id="btn_linhvucnckh_luu"><i class="icon-save"></i> Lưu</span>
...
<script>
    jQuery(document).ready(function($) {
        ...
        $('#btn_linhvucnckh_luu').on('click', function() {
            $('#gritter-notice-wrapper').remove();
            if ($('#form_linhvucnckh').valid() == true) {
                $.blockUI();
                $.ajax({
                    type: 'post',
                    url: 'index.php?option=com_danhmuc&controller=linhvucnckh&task=luu_linhvucnckh',
                    data: $('#form_linhvucnckh').serialize(),
