...
$tongiao = Core::loadAssocList('nat_code','*','id!='.(int)$info['id'],'name asc');
?>
<style>
...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form class="form-horizontal" method="POST" name="frm_tongiao" id="frm_tongiao">
		...
		<div class="modal-footer">
			...
			<span class="btn btn-sm btn-primary pull-right" id="btn_submit_tongiao">
				<i class="ace-icon fa fa-times"></i>
				Lưu
			</span>
		</div>
...
jQuery(document).ready(function($){
	...
	$('#btn_submit_tongiao').click(function(){
		$('.gritter-item-wrapper').remove();
		var flag = $('#frm_tongiao').valid();
		if(flag == true){
			$.blockUI();
			formData = $('#frm_tongiao').serialize();
			$.ajax({
				type: 'post',
				data: formData,
				url: 'index.php?option=com_danhmuc&controller=tongiao&task=save&format=raw&',
