<?php 
	class DanhmucControllerTieuchi_donvi extends DanhmucController{
		...
		public function luu_tieuchi_donvi(){
			$jinput= JFactory::getApplication()->input;
			...
			$model = Core::model('Danhgia/Tieuchidonvi');
			Core::printJson($model->luu_tieuchi_donvi($form,$donvithuocve));exit;
		}
	}
?>