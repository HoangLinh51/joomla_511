...
<div class="danhsach" style="background-color:#fff">
  <div class="content-header">
    <div class="row mb-2">
      <div class="col-sm-8">
        <h3 class="m-0 text-primary"><i class="fas fa-users"></i> Quản lý công dân đến tuổi thực hiện nghĩa vụ quân sự</h3>
      </div>
      <div class="col-sm-4 text-right" style="padding:0;">
        <a href="<?php echo Route::_('/index.php?option=com_quansu&view=dknvqs&task=edit_dknvqs') ?>" class="btn btn-primary" style="font-size:16px;width:136px">
    ...
    <div class="card-body">
      <table class="table table-borderless">
        ...
        <tr class="d-flex align-items-center">
          ...
          <td class="d-flex align-items-center w-50">
            <b class="text-primary" style="font-size:17px;line-height:2.5;text-wrap: nowrap; width: 33%">Phân loại đối tượng</b>
  ...
  <div id="div_danhsach">
    <?php require_once 'ds_dknvqs.php'; ?>
  </div>
</div>
