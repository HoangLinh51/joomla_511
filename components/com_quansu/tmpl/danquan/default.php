...
<div class="danhsach" style="background-color:#fff">
  <div class="content-header">
    <div class="row mb-2">
      <div class="col-sm-8">
        <h3 class="m-0 text-primary"><i class="fas fa-users"></i> Quản lý dân quân </h3>
      </div>
      <div class="col-sm-4 text-right" style="padding:0;">
        <a href="<?php echo Route::_('/index.php?option=com_quansu&view=danquan&task=edit_danquan') ?>" class="btn btn-primary" style="font-size:16px;width:136px">
  ...
  <div id="div_danhsach">
    <?php require_once 'ds_danquan.php'; ?>
  </div>
</div>
