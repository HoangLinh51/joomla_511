...
<form action="index.php" method="post" id="frmThongKeNHK" name="frmThongKeNHK" class="form-horizontal" style="font-size:16px;">
    <div class="container-fluid" style="padding-left:20px; padding-right:20px;">
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-primary"><i class="fas fa-chart-bar"></i> Thống kê đăng ký nghĩa vụ quân sự tuổi 17 </h3>
                </div>
            </div>
        </div>
        <div id="main-right">
                            ...
                            <td style="width:45%;">
                                <select id="loaidoituong_id" name="loaidoituong_id" class="custom-select" data-placeholder="Chọn loại đối tượng">
                                    ...
                                    <?php foreach ($this->loaidoituong as $ldt) { ?>
                                        <option value="<?php echo $ldt['id']; ?>"><?php echo $ldt['tentrangthai']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
...
<script>
    jQuery(document).ready(function($) {
        ...
        // Khởi tạo Select2
        $('#phuongxa_id, #thonto_id, #loaidoituong_id').select2({
            width: '100%',
            allowClear: true,
