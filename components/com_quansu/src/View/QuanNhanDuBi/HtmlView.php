...
class HtmlView extends BaseHtmlView
{
    public function display($tpl = null)
    {
        ...
        $controller = $input->getCmd('view', 'quannhandubi');
        ...
        if ($task === 'DS_QUANNHANDUBI' || $task === 'ADD_QUANNHANDUBI' || $task === 'EDIT_QUANNHANDUBI') {
            $checkTask = 'default';
        }
    ...
    {
          $loaidoituong = Core::loadAssocList('danhmuc_trangthaiquansu', 'id,tentrangthai', 'trangthai = 1 AND daxoa = 0 AND type = 3');
