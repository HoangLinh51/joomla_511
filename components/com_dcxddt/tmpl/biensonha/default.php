...
<form action="index.php" method="post" id="frmGiadinhvanhoa" name="frmGiadinhvanhoa" class="form-horizontal" style="font-size:16px;background:white">
    <div class="container-fluid" style="padding-left:20px; padding-right:20px;">
        ...
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-primary"><i class="fas fa-users"></i> Quản lý gia thông tin biển số nhà</h3>
                </div>
                <div class="col-sm-6 text-right" style="padding:0;">
                    <?php if ($is_quyen == 0) { ?>
                        <a href="index.php?option=com_dcxddt&view=biensonha&task=add_bsn" class="btn btn-primary" style="font-size:16px;width:136px">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%; padding: 10px;">
                                <select id="tenduong" name="tenduong" class="custom-select" data-placeholder="Chọn tuyến đường">
                                    <option value=""></option>
                                    <?php foreach ($this->tuyenduong as $px) { ?>
                                        <option value="<?php echo $px['id']; ?>"><?php echo $px['tenduong']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
...
<script>
    $(document).ready(function($) {
        ...
        // Khởi tạo Select2
        $('#tenduong, #phuongxa_id, #thonto_id').select2({
            width: '100%',
            allowClear: true,
