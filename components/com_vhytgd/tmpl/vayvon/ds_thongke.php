...
<table class="table table-striped table-bordered table-hover" id="tblDanhsach">
    <thead>
        ...
        <tr class="bg-primary">
            ...
            <th style="vertical-align:middle;" class="text-center" rowspan="2">Khu vực</th>
            <th style="vertical-align:middle;" class="text-center" colspan="2">Giới tính</th>
            <th style="vertical-align:middle;" class="text-center" colspan="3">Tổng số công dân</th>
        </tr>
        <tr class="bg-primary">
            <th style="vertical-align:middle;" class="text-center">Nam</th>
            <th style="vertical-align:middle;" class="text-center">Nữ</th>
            <th style="vertical-align:middle;" class="text-center">thường trú</th>
            <th style="vertical-align:middle;" class="text-center">Tạm trú</th>
            <th style="vertical-align:middle;" class="text-center">Trên 18 tuổi</th>
        </tr>
    </thead>
    </thead>
