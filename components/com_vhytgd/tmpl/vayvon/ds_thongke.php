...
<table class="table table-striped table-bordered table-hover" id="tblDanhsach">
    <thead>
        <thead>
            <tr class="bg-primary">
                ...
                <th style="vertical-align:middle;color:#FFF!important;" class="text-center">Số người vay vốn</th>
                <th style="vertical-align:middle;color:#FFF!important;" class="text-center">Tổng số tiền vay</th>
            </tr>
        </thead>
    </thead>
    <tbody id="tbody_danhsach">
        <?php foreach ($this->items as $i => $item) : ?>
            ...
            ?>
            <tr>
                <?php if ($item['tongsonguoivayvon'] == '0') : ?>
                ...
                <?php else : ?>
                    ...
                    <td style="vertical-align:middle;"><?php echo htmlspecialchars($item['tongsonguoivayvon']); ?></td>
