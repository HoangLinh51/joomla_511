  ...
  <div class="card-body">
    <div class="d-flex align-items-center justify-content-between border-bottom mb-3">
      <h2 class="text-primary mb-3">
        <?php echo ((int)$detailDkTuoi17->id > 0) ? "Hiệu chỉnh" : "Thêm mới"; ?> thông tin gia đình và trẻ em
      </h2>
      <span>
    ...
    <h5 class="border-bottom pb-2 mb-4">Thông tin khác</h5>
     <div class="row g-3 mb-4">
            <div class="col-md-4 mb-2">
                <label for="namsinh" class="form-label fw-bold">Mã hộ gia đình</label>
                <div class="input-group">
                    <input type="text" id="mahogiadinh" name="mahogiadinh" class="form-control" placeholder="Nhập mã hộ gia đình" value="<?php echo htmlspecialchars($item[0]['makh']); ?>">
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-md-4">
        ...
        <div class="input-group">
          <input type="text" id="form_ngaydangky" name="form_ngaydangky" class="form-control ngaydangky" placeholder="dd/mm/yyyy" value="<?php echo htmlspecialchars($detailDkTuoi17->ngaydangky); ?>">
          <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
        </div>
      </div>
    </div>
