...
<form action="index.php" method="post" id="frmDoituonghuongcs" name="frmDoituonghuongcs" class="form-horizontal" style="font-size:16px;background:white">
	<div class="container-fluid" style="padding-left:20px; padding-right:20px;">
		<div class="content-header">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h3 class="m-0 text-primary"><i class="fas fa-users"></i>Quản lý thông tin gia đình và trẻ em</h3>
				</div>
				<div class="col-sm-6 text-right" style="padding:0;">
					<?php if ($is_quyen == 0) { ?>

						<a href="index.php?option=com_vhytgd&view=giadinhtreem&task=add_gdte" class="btn btn-primary" style="font-size:16px;width:136px">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover" id="tblDanhsach">
						<tr class="bg-primary text-white">
							...
							<th style="vertical-align:middle" class="text-center">Mã hộ gia đình</th>
							...
							<th style="vertical-align:middle" class="text-center">Bạo lực gia đình</th>
							<th style="vertical-align:middle" class="text-center">Hỗ trợ trẻ em</th>
