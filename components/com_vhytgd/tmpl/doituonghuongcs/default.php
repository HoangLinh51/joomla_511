...
<form action="index.php" method="post" id="frmDoituonghuongcs" name="frmDoituonghuongcs" class="form-horizontal" style="font-size:16px;background:white">
	<div class="container-fluid" style="padding-left:20px; padding-right:20px;">
		<div class="content-header">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h3 class="m-0 text-primary"><i class="fas fa-users"></i> Quản lý đối tượng hưởng chính sách</h3>
				</div>
				<div class="col-sm-6 text-right" style="padding:0;">
					<?php if ($is_quyen == 0) { ?>
						
						<a href="index.php?option=com_vhytgd&view=doituonghuongcs&task=add_dtcs" class="btn btn-primary" style="font-size:16px;width:136px">
					...
					<table class="table table-striped table-bordered table-hover" id="tblDanhsach">
						<thead>
							<tr style="background-color: #FBFBFB !important;" class="bg-primary text-white">
								...
								<th style="vertical-align:middle;color:#4F4F4F!important;" class="text-center">Mã đối tượng</th>
								<th style="vertical-align:middle;color:#4F4F4F!important;" class="text-center">Thông tin đối tượng</th>
								<th style="vertical-align:middle;color:#4F4F4F!important;" class="text-center">Địa chỉ</th>
								<th style="vertical-align:middle;color:#4F4F4F!important;" class="text-center">Loại đối tượng</th>
...
<script>
	jQuery(document).ready(function($) {
		...
		$('body').delegate('.btn_hieuchinh', 'click', function() {
			window.location.href = 'index.php?option=com_vhytgd&view=doituonghuongcs&task=edit_nhk&id=' + $(this).data('hokhau');
		});
