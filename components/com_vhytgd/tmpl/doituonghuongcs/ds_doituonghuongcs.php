...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('body').on('click', '.btn_cathuong', function() {
            ...
            $.ajax({
                url: 'index.php?option=com_vhytgd&task=doituonghuongcs.checkCatHuong',
                type: 'GET',
                data: {
        ...
        $('body').on('click', '.btn_xoa', function() {
            ...
            bootbox.confirm({
                ...
                callback: function(result) {
                    ...
                    // Gửi yêu cầu AJAX
                    $.ajax({
                        url: Joomla.getOptions('system.paths').base + '/index.php?option=com_vhytgd&controller=doituonghuongcs&task=removeDoiTuongChinhSach',
                        type: 'POST',
                        data: {
        ...
        $('#btn_save_cathuong').on('click', function() {
            ...
            if ($form.valid()) {
                ...
                $.ajax({
                    url: Joomla.getOptions('system.paths').base + '/index.php?option=com_vhytgd&controller=doituonghuongcs&task=' + task,
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    success: function(response) {
