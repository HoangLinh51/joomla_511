...
<form action="index.php" method="post" id="frmNhanhokhau" name="frmNhanhokhau" class="form-horizontal" style="font-size:16px;background:white">
    <div class="container-fluid" style="padding-left:20px; padding-right:20px;">
        ...
        <div class="content-header">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0 text-primary"><i class="fas fa-users"></i> Quản lý thông tin thiết chế</h3>
                </div>
                <div class="col-sm-6 text-right" style="padding:0;">
                    <?php if ($is_quyen == 0) { ?>
                        <a href="index.php?option=com_vhytgd&view=thongtinthietche&task=add_thietche" class="btn btn-primary" style="font-size:16px;width:136px">
                        ...
                        <tr>
                            ...
                            <td style="width: 40%; padding: 10px;">
                                <select id="loaihinhthietche_id" name="loaihinhthietche_id" class="custom-select" data-placeholder="Chọn loại hình thiết chế">
                                    <option value=""></option>
                                    <?php foreach ($this->loaihinhthietche as $ll) { ?>
                                        <option value="<?php echo $ll['id']; ?>"><?php echo $ll['tenloaihinhthietche']; ?></option>
                                    <?php } ?>
                                </select>
                            </td>
