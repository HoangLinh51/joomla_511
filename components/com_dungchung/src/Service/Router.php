...
namespace J4xdemos\Component\DungChung\Site\Service;
...
class Router extends RouterView
{
			...
			CategoryFactoryInterface $categoryFactory, DatabaseInterface $db)
	{
		...
		$params = ComponentHelper::getParams('com_dungchung');
		$this->noIDs = (bool) $params->get('sef_ids');

		$dungchung = new RouterViewConfiguration('dungchung');
		$dungchung->setKey('id');
		$this->registerView($dungchung);
