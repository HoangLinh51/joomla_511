 ...
 * @ Modified time: 2024-08-30 17:04:05
 * @ Description:
 */
            ...
            <div id="COM_TOCHUC_THANHLAP_TAB1" class="tab-pane active" style="min-width:1000px;">
                <fieldset>
                    ...
                    <div class="tab-custom-content">
                        ...
                        <div style="display: none;" class="fileupload_quatrinh_list dropzone dropzone-multi col-lg-6">
                            <div class="dropzone-items wm-200px">
                                <div id="fileupload_quatrinh_list" class="dropzone-item">
                      ...
                      <!--   <div class="row" data-select2-id="30">
                            <div class="col-md-6">
                                <div class="<?php //echo $this->iddiv; ?> dropzone dropzone-multi col-lg-8"></div>
        ...
        $('#fileupload_quatrinh').fileupload({
	        ...
	        formData: {created_by: '<?php echo $user->id;?>'},
	            ...
	            $.each(data.result.files, function (index, file) {
	                $('#fileupload_quatrinh_list').html('<li id="file_'+file.id+'" ><input type="hidden" name="fileupload_id[]" value="'+file.id+'"><a onclick="deleteFileById('+file.id+',\''+file.deleteUrl+'\')" class="btn btn-minier btn-danger" href="javascript:void(0);"><i class="icon-trash"></i></a> <a href="'+file.url+'" target="_blank">'+file.filename+'</a></li>');
	            });
	        }
	    });
