 ...
 * @ Modified time: 2024-08-16 14:59:40
 * @ Description:
 */
					...
					<div class="tab-custom-content">
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<div class="controls">
									<input type="text" value="<?php echo $this->row->name; ?>" name="name" id="name" class="form-control rounded-0">
								</div>
							</div>
							<div class="col-md-6 form-group">
								<label class="control-label" for="s_name">Tên viết tắt <span class="required">*</span></label>
								<div class="controls">
									<input class="form-control rounded-0 " type="text" value="<?php echo $this->row->s_name; ?>" name="s_name" id="s_name">
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 form-group" style="width:450px;float:left;">
							<label class="control-label" for="ghichu">Ghi chú</label>
							<div class="controls">
								<textarea class="form-control rounded-0" rows="5" cols="30" id="ghichu" name="ghichu"><?php echo $this->row->ghichu; ?></textarea>
							</div>
						</div>
					</div>
				</fieldset>
