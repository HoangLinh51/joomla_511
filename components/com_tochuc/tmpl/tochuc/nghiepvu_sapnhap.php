 ...
 * @ Modified time: 2024-08-27 16:25:17
 * @ Description:
 */
...
<form class="form-horizontal row-fluid" name="frmThanhLap" id="frmThanhLap" method="post" action="<?php echo Route::_('index.php?option=com_tochuc&controller=tochuc&task=savethanhlap') ?>" enctype="multipart/form-data">
    ...
    <div class="">
        <div class="card-header">
	        <h3 class="card-title" style="vertical-align: middle;padding-top: 10px;">Nghiệp vụ sáp nhập <?php echo TochucHelper::getNameById($this->type, 'ins_type'); ?></h3>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#com_tochuc_thongbao').html('<div style="margin-bottom:0px;" class="alert alert-warning"><b>Chú ý:</b> Sau khi sáp nhập (nếu chọn Điều động nhân sự), các tất cả các hồ sơ sẽ chuyển đến Tổ chức chính</div>')
