                ...
                <div id="COM_TOCHUC_THANHLAP_TAB1" class="tab-pane active" style="">
                    ...
                    <fieldset>
                        ...
                        <div class="tab-custom-content">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="div_quyetdinhlienquan" style="display: none;">
                                        <div class="controls">
...
jQuery(document).ready(function($) {
    ...
    var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        url: "/index.php?option=com_tochuc&controller=tochuc&task=upload", // Set the url
        thumbnailWidth: 80,
        thumbnailHeight: 80,
        parallelUploads: 20,
    ...
    jQuery("#actions .start").on('click', function() {
        myDropzone.enqueueFiles(myDropzone.getFilesWithStatus(Dropzone.ADDED))
    })
    jQuery("#actions .cancel").on('click', function() {
