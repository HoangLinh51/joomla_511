...
namespace Joomla\Component\Tochuc\Site\Service;
 ...
 * @since  3.4
 */
class TochucNomenuRules implements RulesInterface
{
	/**
	...
	public function build(&$query, &$segments)
	{
		...
		if (!isset($query['view']) || (isset($query['view']) && $query['view'] !== 'tochuc') || isset($query['format']))
		{
			return;
		}
